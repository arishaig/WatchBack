...
/// <param name="Url">
///     Some Thoughts have a source URL specific to the Thought, such as the link to a specific Reddit
///     comment
/// </param>
/// <param name="Images">
///     Some Thoughts have one or more images, such as inline images in a Bluesky post or a gallery from a
///     review
/// </param>
/// <param name="Author">
///     All Thoughts have an Author, usually a specific human who wrote the content, but potentially an
///     organization
/// </param>
