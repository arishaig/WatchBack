...
public partial class OmdbMediaSearchProvider
{
    ...
    public async Task<IReadOnlyList<MediaRating>> GetRatingsAsync(string imdbId, CancellationToken ct = default)
    {
        ...
        var response = await FetchJsonAsync<OmdbTitleDetailResponse>(url, ct);
...
internal sealed record OmdbTitleDetailResponse(
    [property: JsonPropertyName("Ratings")] OmdbRatingItem[]? Ratings,
